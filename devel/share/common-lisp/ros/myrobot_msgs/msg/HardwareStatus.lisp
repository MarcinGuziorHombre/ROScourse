...
(cl:defmethod cl:initialize-instance :after ((m <HardwareStatus>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'HardwareStatus)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name myrobot_msgs-msg:<HardwareStatus> is deprecated: use myrobot_msgs-msg:HardwareStatus instead.")))

(cl:ensure-generic-function 'temeprature-val :lambda-list '(m))
(cl:defmethod temeprature-val ((m <HardwareStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader myrobot_msgs-msg:temeprature-val is deprecated.  Use myrobot_msgs-msg:temeprature instead.")
  (temeprature m))

(cl:ensure-generic-function 'are_motors_up-val :lambda-list '(m))
(cl:defmethod are_motors_up-val ((m <HardwareStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader myrobot_msgs-msg:are_motors_up-val is deprecated.  Use myrobot_msgs-msg:are_motors_up instead.")
  (are_motors_up m))

(cl:ensure-generic-function 'debug_message-val :lambda-list '(m))
(cl:defmethod debug_message-val ((m <HardwareStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader myrobot_msgs-msg:debug_message-val is deprecated.  Use myrobot_msgs-msg:debug_message instead.")
  (debug_message m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <HardwareStatus>) ostream)
  "Serializes a message object of type '<HardwareStatus>"
  (cl:let* ((signed (cl:slot-value msg 'temeprature)) (unsigned (cl:if (cl:< signed 0) (cl:+ signed 18446744073709551616) signed)))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <HardwareStatus>) istream)
  "Deserializes a message object of type '<HardwareStatus>"
    (cl:let ((unsigned 0))
      ...
      (cl:setf (cl:slot-value msg 'temeprature) (cl:if (cl:< unsigned 9223372036854775808) unsigned (cl:- unsigned 18446744073709551616))))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<HardwareStatus>)))
  ...
  "fe1da4b9c6239c068532b95d312bfc8f")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'HardwareStatus)))
  "Returns md5sum for a message object of type 'HardwareStatus"
  "fe1da4b9c6239c068532b95d312bfc8f")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<HardwareStatus>)))
  ...
  (cl:format cl:nil "int64 temeprature~%bool are_motors_up~%string debug_message~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'HardwareStatus)))
  "Returns full string definition for message of type 'HardwareStatus"
  (cl:format cl:nil "int64 temeprature~%bool are_motors_up~%string debug_message~%~%~%"))
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <HardwareStatus>))
  ...
  (cl:list 'HardwareStatus
    (cl:cons ':temeprature (temeprature msg))
